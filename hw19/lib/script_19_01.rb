# =================================================================================== 
# Script = script_19_01.rb 
# =================================================================================== 
# Description = "robots.txt verification" 
# Name = "Kristina Rudzinskaya" 
# Email = "kristina.rudzinskaya@email.com" 
# =================================================================================== 
require 'net/http' 
require 'uri' 
require 'rspec' 
...
raise RSpec::Expectations::ExpectationNotMetError, "File #{url} does not exists, code: #{status[:code]}, expected code: 200" unless status[:code] == "200" 
...
EOB
 ...
 opt :verbose, "Print statements about the execution of the test during the run", :short => "-v" 
 opt :debug, "Print trace statements during the execution for debugging the test" 
 end 
